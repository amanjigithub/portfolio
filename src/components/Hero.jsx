      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} text-white-100 mt-2`}>
            BTech CSE Student &  {personalInfo.role}, <br className="sm:block hidden" />
            Passionate about Cloud Computing & AI/ML
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <div className="text-secondary text-[14px] sm:text-[16px]">
              <p>📧 {personalInfo.email}</p>
              <p>📱 {personalInfo.number}</p>
              <p>📍 <a href="https://maps.app.goo.gl/cQGxiUtZRJ17Lueg8" target="_blank" rel="noopener">Sadabad, Hathars, Uttar Pradesh 281306</a></p>
            </div>
          </div>
        </div>
      </div>
